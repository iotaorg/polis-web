...
<nav class="nav-top visible-xs">
    ...
    <img src="/static/css/images/logo-monitoramento-branco.svg" border="0">
            ...
            <div class="apoio-wrap col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <div style="background-color: white; overflow:auto">
                    <a title="Ir para Petrobras" target="_blank" class="a-block" href="http://www.petrobras.com.br/pt/">
                        <img src="/static/css/images/petrobras-logo.png" style="width: 100%;"/>
                    </a>
                </div>

                <div style=" background-color: white; overflow:auto;">
                    <a title="Ir para Polis" target="_blank" class="a-block" href="http://polis.org.br/">
                        <img style=" padding: 15px" src="/static/css/images/logo_polis_invertido.png" />
                    </a>

                    <a title="Ir para Litoral Sustentavel" target="_blank" class="a-block" href="http://litoralsustentavel.org.br/" >
                        <img alt="Logo Observatório Litoral Sustentável" src="/static/css/images/logo-obs-preto.png" style="width: 325px"/>
                    </a>
                </div>

                <div style="overflow:auto; text-align: right">
                    <a style="display:inline-block; width: 49%;" href="http://www.brasil.gov.br/" target="_blank" >
                        <img src="/static/css/images/governo-federal-Temer.jpg" style="max-width: 100%; margin-top: 5px">
                    </a>
                    <a style="display:inline-block; width: 50%"  title="Ir para Iota" target="_blank" href="https://github.com/eokoe/Iota">
                        <img style="max-width: 40%; margin-right: 30%" alt="Logo do sistema IOTA" src="/static/css/images/iota-negativo.svg" >
                    </a>
                </div>
...
<footer class="footer-creditos">
    <div class="container">
        <div class="row">
            ...
            <div class="cc-wrap col-lg-4 col-md-4 col-sm-4 col-xs-12">Alguns direitos reservados <img src="/static/css/images/cc.png"></div>
        </div>
    </div>
</footer>
